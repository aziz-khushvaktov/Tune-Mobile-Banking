...
class HomeScreen : Fragment() {
    ...
    private fun initViews() {
        ...
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText(resources.getString(R.string.str_hammasi)))
        ...
        binding.tabLayout.addTab(binding.tabLayout.newTab().setText(resources.getString(R.string.str_xalqaro)))
    }
